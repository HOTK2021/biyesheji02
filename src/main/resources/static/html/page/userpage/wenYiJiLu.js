    ...
    table.render({
        ...
        ,cols: [[
            ...
            ,{field: 'btn',title: '操作',templet:function (d) {
                    ...
                    return '<button class="layui-btn" onclick="showDieUser('+plague_info_id+')">瘟疫死亡名单</button>'
                }}
        ]]
    })
})
...
function showDieUser(plague_info_id) {
    layui.use(['table','jquery'],function () {
        ...
        table.render({
            ...
            ,cols: [[
                {field: 'id',title: 'ID',sort: true,width: 300}
                ,{field: 'userid',title: '用户ID',sort: true,width: 300}
