...
public class T_user_s {
	...
	public T_user_s(BigInteger user_id, String username, String password, BigInteger dept_id, String email, String mobile, int status,
	...
	public T_user_s(String username, String password, BigInteger dept_id, String email, String mobile, int status,
                    String create_time, String modify_time, String last_login_time, String ssex, String description,
                    String avatar, int age) {
		this.username = username;
		this.password = password;
	...
	public String toString() {
		return "T_user_s [user_id=" + user_id + ", username=" + username + ", password=" + password + ", dept_id="
